import { Circle, SendToBack, Sparkle, Target } from "lucide-react";
            ...
            <div className="cards-top grid grid-cols-2  divide-x-2 divide-light ">
              <div className="grid grid-cols-[70px_1fr] gap-6 items-start">
                ...
                <div className="max-w-[500px]">
                  <h4 className="font-[syne] uppercase text-4xl font-normal mb-5 leading-[120%]">
                    Branding
                  </h4>
                  <p className="w-[80%] leading-[200%]">
              ...
              <div className="grid grid-cols-[70px_1fr] gap-6 items-start pl-10">
                <SendToBack strokeWidth={0.4} size={80} />
                <div className="max-w-[500px]">
                  <h4 className="font-[syne] uppercase text-4xl font-normal mb-5 leading-[120%]">
                    Design
                  </h4>
